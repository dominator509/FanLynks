UPDATE pages SET
  ...
  announcement_text = 'Fanlynks creator beta is opening soon',
  announcement_url = 'https://fanlynks.com/join',
  hero_cta_label = 'Start creating your Fanlynks page',
...
('link_fanlynks_creators','page_demo',NULL,'For influencers, Fanvue creators, and premium creators','Designed for influencers, premium creators, and fan-led brands.','https://fanlynks.com/creators','none',NULL,NULL,'neutral',4,1,NULL,NULL,datetime('now'),datetime('now')),
('link_fanlynks_contact','page_demo',NULL,'Contact or partner with Fanlynks','Partnerships, launch questions, and creator support.','https://fanlynks.com/contact','none',NULL,NULL,'neutral',5,1,NULL,NULL,datetime('now'),datetime('now'));
